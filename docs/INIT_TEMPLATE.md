...
After init, the `scripts/` folder is removed. Pair with [cf-hono-supabase-gemini-api-template](https://github.com/open-templates/cf-hono-supabase-gemini-api-template) (or another AI-chat-pack backend) using the same GitHub owner.
